...
import (
	...
	context "context"
	errors "errors"
	v1 "go.admiral.io/sdk/proto/admiral/user/v1"
	http "net/http"
	strings "strings"
)
...
func NewUserAPIClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserAPIClient {
	...
	userAPIMethods := v1.File_admiral_user_v1_user_proto.Services().ByName("UserAPI").Methods()
...
// CreatePersonalAccessToken calls admiral.user.v1.UserAPI.CreatePersonalAccessToken.
...
// ListPersonalAccessTokens calls admiral.user.v1.UserAPI.ListPersonalAccessTokens.
...
// GetPersonalAccessToken calls admiral.user.v1.UserAPI.GetPersonalAccessToken.
...
// UpdatePersonalAccessToken calls admiral.user.v1.UserAPI.UpdatePersonalAccessToken.
...
// RevokePersonalAccessToken calls admiral.user.v1.UserAPI.RevokePersonalAccessToken.
...
func (UnimplementedUserAPIHandler) CreatePersonalAccessToken(context.Context, *connect.Request[v1.CreatePersonalAccessTokenRequest]) (*connect.Response[v1.CreatePersonalAccessTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.user.v1.UserAPI.CreatePersonalAccessToken is not implemented"))
}
...
func (UnimplementedUserAPIHandler) ListPersonalAccessTokens(context.Context, *connect.Request[v1.ListPersonalAccessTokensRequest]) (*connect.Response[v1.ListPersonalAccessTokensResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.user.v1.UserAPI.ListPersonalAccessTokens is not implemented"))
}
...
func (UnimplementedUserAPIHandler) GetPersonalAccessToken(context.Context, *connect.Request[v1.GetPersonalAccessTokenRequest]) (*connect.Response[v1.GetPersonalAccessTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.user.v1.UserAPI.GetPersonalAccessToken is not implemented"))
}
...
func (UnimplementedUserAPIHandler) UpdatePersonalAccessToken(context.Context, *connect.Request[v1.UpdatePersonalAccessTokenRequest]) (*connect.Response[v1.UpdatePersonalAccessTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.user.v1.UserAPI.UpdatePersonalAccessToken is not implemented"))
}
...
func (UnimplementedUserAPIHandler) RevokePersonalAccessToken(context.Context, *connect.Request[v1.RevokePersonalAccessTokenRequest]) (*connect.Response[v1.RevokePersonalAccessTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.user.v1.UserAPI.RevokePersonalAccessToken is not implemented"))
}
