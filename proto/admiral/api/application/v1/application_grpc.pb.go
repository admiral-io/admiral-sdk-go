...
const (
	ApplicationAPI_CreateApplication_FullMethodName = "/admiral.api.application.v1.ApplicationAPI/CreateApplication"
	ApplicationAPI_GetApplication_FullMethodName    = "/admiral.api.application.v1.ApplicationAPI/GetApplication"
	ApplicationAPI_ListApplications_FullMethodName  = "/admiral.api.application.v1.ApplicationAPI/ListApplications"
	ApplicationAPI_UpdateApplication_FullMethodName = "/admiral.api.application.v1.ApplicationAPI/UpdateApplication"
	ApplicationAPI_DeleteApplication_FullMethodName = "/admiral.api.application.v1.ApplicationAPI/DeleteApplication"
)
...
func RegisterApplicationAPIServer(s grpc.ServiceRegistrar, srv ApplicationAPIServer) {
	// If the following call panics, it indicates UnimplementedApplicationAPIServer was
...
var ApplicationAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admiral.api.application.v1.ApplicationAPI",
	...
	Metadata: "admiral/api/application/v1/application.proto",
}
