...
import (
	...
	context "context"
	errors "errors"
	v1 "go.admiral.io/sdk/proto/admiral/api/cluster/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ClusterAPIGetRevisionBundleProcedure = "/admiral.api.cluster.v1.ClusterAPI/GetRevisionBundle"
	// ClusterAPIReportRevisionResultProcedure is the fully-qualified name of the ClusterAPI's
	// ReportRevisionResult RPC.
	ClusterAPIReportRevisionResultProcedure = "/admiral.api.cluster.v1.ClusterAPI/ReportRevisionResult"
)
...
func NewClusterAPIClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ClusterAPIClient {
	...
	clusterAPIMethods := v1.File_admiral_api_cluster_v1_cluster_proto.Services().ByName("ClusterAPI").Methods()
...
// GetRevisionBundle calls admiral.api.cluster.v1.ClusterAPI.GetRevisionBundle.
...
// ReportRevisionResult calls admiral.api.cluster.v1.ClusterAPI.ReportRevisionResult.
...
func (UnimplementedClusterAPIHandler) GetRevisionBundle(context.Context, *connect.Request[v1.GetRevisionBundleRequest]) (*connect.Response[v1.GetRevisionBundleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.cluster.v1.ClusterAPI.GetRevisionBundle is not implemented"))
}
...
func (UnimplementedClusterAPIHandler) ReportRevisionResult(context.Context, *connect.Request[v1.ReportRevisionResultRequest]) (*connect.Response[v1.ReportRevisionResultResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.cluster.v1.ClusterAPI.ReportRevisionResult is not implemented"))
}
