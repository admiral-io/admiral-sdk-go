...
import (
	...
	context "context"
	errors "errors"
	v1 "go.admiral.io/sdk/proto/admiral/api/source/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SourceAPIName = "admiral.api.source.v1.SourceAPI"
)
...
const (
	...
	SourceAPICreateSourceProcedure = "/admiral.api.source.v1.SourceAPI/CreateSource"
	// SourceAPIGetSourceProcedure is the fully-qualified name of the SourceAPI's GetSource RPC.
	SourceAPIGetSourceProcedure = "/admiral.api.source.v1.SourceAPI/GetSource"
	// SourceAPIListSourcesProcedure is the fully-qualified name of the SourceAPI's ListSources RPC.
	SourceAPIListSourcesProcedure = "/admiral.api.source.v1.SourceAPI/ListSources"
	// SourceAPIUpdateSourceProcedure is the fully-qualified name of the SourceAPI's UpdateSource RPC.
	SourceAPIUpdateSourceProcedure = "/admiral.api.source.v1.SourceAPI/UpdateSource"
	// SourceAPIDeleteSourceProcedure is the fully-qualified name of the SourceAPI's DeleteSource RPC.
	SourceAPIDeleteSourceProcedure = "/admiral.api.source.v1.SourceAPI/DeleteSource"
	// SourceAPIListSourceVersionsProcedure is the fully-qualified name of the SourceAPI's
	// ListSourceVersions RPC.
	SourceAPIListSourceVersionsProcedure = "/admiral.api.source.v1.SourceAPI/ListSourceVersions"
	// SourceAPIGetSourceInputsProcedure is the fully-qualified name of the SourceAPI's GetSourceInputs
	// RPC.
	SourceAPIGetSourceInputsProcedure = "/admiral.api.source.v1.SourceAPI/GetSourceInputs"
	// SourceAPIGetSourceOutputsProcedure is the fully-qualified name of the SourceAPI's
	// GetSourceOutputs RPC.
	SourceAPIGetSourceOutputsProcedure = "/admiral.api.source.v1.SourceAPI/GetSourceOutputs"
	// SourceAPISyncSourceProcedure is the fully-qualified name of the SourceAPI's SyncSource RPC.
	SourceAPISyncSourceProcedure = "/admiral.api.source.v1.SourceAPI/SyncSource"
)

// SourceAPIClient is a client for the admiral.api.source.v1.SourceAPI service.
...
// NewSourceAPIClient constructs a client for the admiral.api.source.v1.SourceAPI service. By
...
func NewSourceAPIClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SourceAPIClient {
	...
	sourceAPIMethods := v1.File_admiral_api_source_v1_source_proto.Services().ByName("SourceAPI").Methods()
...
// CreateSource calls admiral.api.source.v1.SourceAPI.CreateSource.
...
// GetSource calls admiral.api.source.v1.SourceAPI.GetSource.
...
// ListSources calls admiral.api.source.v1.SourceAPI.ListSources.
...
// UpdateSource calls admiral.api.source.v1.SourceAPI.UpdateSource.
...
// DeleteSource calls admiral.api.source.v1.SourceAPI.DeleteSource.
...
// ListSourceVersions calls admiral.api.source.v1.SourceAPI.ListSourceVersions.
...
// GetSourceInputs calls admiral.api.source.v1.SourceAPI.GetSourceInputs.
...
// GetSourceOutputs calls admiral.api.source.v1.SourceAPI.GetSourceOutputs.
...
// SyncSource calls admiral.api.source.v1.SourceAPI.SyncSource.
...
// SourceAPIHandler is an implementation of the admiral.api.source.v1.SourceAPI service.
...
func NewSourceAPIHandler(svc SourceAPIHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/admiral.api.source.v1.SourceAPI/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSourceAPIHandler) CreateSource(context.Context, *connect.Request[v1.CreateSourceRequest]) (*connect.Response[v1.CreateSourceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.CreateSource is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) GetSource(context.Context, *connect.Request[v1.GetSourceRequest]) (*connect.Response[v1.GetSourceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.GetSource is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) ListSources(context.Context, *connect.Request[v1.ListSourcesRequest]) (*connect.Response[v1.ListSourcesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.ListSources is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) UpdateSource(context.Context, *connect.Request[v1.UpdateSourceRequest]) (*connect.Response[v1.UpdateSourceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.UpdateSource is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) DeleteSource(context.Context, *connect.Request[v1.DeleteSourceRequest]) (*connect.Response[v1.DeleteSourceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.DeleteSource is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) ListSourceVersions(context.Context, *connect.Request[v1.ListSourceVersionsRequest]) (*connect.Response[v1.ListSourceVersionsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.ListSourceVersions is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) GetSourceInputs(context.Context, *connect.Request[v1.GetSourceInputsRequest]) (*connect.Response[v1.GetSourceInputsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.GetSourceInputs is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) GetSourceOutputs(context.Context, *connect.Request[v1.GetSourceOutputsRequest]) (*connect.Response[v1.GetSourceOutputsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.GetSourceOutputs is not implemented"))
}
...
func (UnimplementedSourceAPIHandler) SyncSource(context.Context, *connect.Request[v1.SyncSourceRequest]) (*connect.Response[v1.SyncSourceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admiral.api.source.v1.SourceAPI.SyncSource is not implemented"))
}
